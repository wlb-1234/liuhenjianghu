...
## v1.7.0 (2026-06-21)
### 新增功能
- 实名认证页面 `/realname` - 用户提交实名认证申请
- 管理后台实名认证管理 `/admin/realname` - 管理员审核认证申请
- 帖子详情页分享功能 - 支持分享漂流信到其他应用
- App图标 - 漂流江湖主题图标

### 数据库更新
- 新增 `realname_verifications` 表

### 新增补丁
- `04_CODE_PATCHES/realname_auth.patch.md` - 实名认证功能
