...
const CITIES: Record<string, Array<{ code: string; name: string }>> = {
  ...
  '63': [
    { code: '6301', name: '西宁市' }, { code: '6302', name: '海东市' }, { code: '6323', name: '海北藏族自治州' },
    { code: '6326', name: '黄南藏族自治州' }, { code: '6327', name: '海南藏族自治州' },
    { code: '6328', name: '果洛藏族自治州' }, { code: '6329', name: '玉树藏族自治州' },
    { code: '6330', name: '海西蒙古族藏族自治州' }
  ],
  '64': [
...
const DISTRICTS: Record<string, Array<{ code: string; name: string }>> = {
  ...
  '5001': [
    ...
    { code: '500113', name: '巴南区' }, { code: '500115', name: '黔江区' }
  ]
};
