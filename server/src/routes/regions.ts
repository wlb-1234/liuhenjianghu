...
const cities: Record<string, { code: string; name: string }[]> = {
  ...
  "15": [
    ...
    { code: "1521", name: "兴安盟" }, { code: "1522", name: "锡林郭勒盟" }, { code: "1523", name: "阿拉善盟" }
  ],
  "21": [
  ...
  "53": [
    { code: "5301", name: "昆明市" }, { code: "5302", name: "曲靖市" }, { code: "5303", name: "玉溪市" },
    { code: "5304", name: "保山市" }, { code: "5305", name: "昭通市" }, { code: "5306", name: "丽江市" },
    { code: "5307", name: "普洱市" }, { code: "5308", name: "临沧市" }, { code: "5323", name: "楚雄彝族自治州" },
  ...
  "65": [
    { code: "6501", name: "乌鲁木齐市" }, { code: "6502", name: "克拉玛依市" }, { code: "6503", name: "吐鲁番市" },
    { code: "6504", name: "哈密市" }, { code: "6523", name: "昌吉回族自治州" },
    { code: "6527", name: "博尔塔拉蒙古自治州" }, { code: "6528", name: "巴音郭楞蒙古自治州" },
    { code: "6529", name: "阿克苏地区" }, { code: "6530", name: "克孜勒苏柯尔克孜自治州" },
    { code: "6531", name: "喀什地区" }, { code: "6532", name: "和田地区" },
    { code: "6540", name: "伊犁哈萨克自治州" }, { code: "6542", name: "塔城地区" },
    { code: "6543", name: "阿勒泰地区" }
  ],
  "71": [
    { code: "7101", name: "台北市" }, { code: "7102", name: "高雄市" }, { code: "7103", name: "基隆市" },
    { code: "7104", name: "台中市" }, { code: "7105", name: "台南市" }, { code: "7106", name: "新竹市" },
    { code: "7107", name: "嘉义市" }, { code: "7121", name: "新北市" }
  ],
  "81": [
    { code: "8101", name: "香港岛" }, { code: "8102", name: "九龙半岛" }, { code: "8103", name: "新界" }
  ],
  "82": [
    { code: "8201", name: "澳门半岛" }, { code: "8202", name: "氹仔岛" }, { code: "8203", name: "路环岛" }
  ]
};
...
const districts: Record<string, { code: string; name: string }[]> = {
  ...
  "1201": [
    ...
    { code: "120116", name: "滨海新区" }, { code: "120118", name: "宁河区" }, { code: "120119", name: "静海区" },
  ...
  "1302": [
    { code: "130202", name: "路南区" }, { code: "130204", name: "路北区" }, { code: "130205", name: "古冶区" },
    { code: "130207", name: "开平区" }, { code: "130209", name: "丰南区" }, { code: "130210", name: "丰润区" },
    { code: "130211", name: "曹妃甸区" }, { code: "130223", name: "滦南县" }, { code: "130224", name: "乐亭县" },
    { code: "130225", name: "迁西县" }, { code: "130227", name: "玉田县" }, { code: "130281", name: "迁安市" },
  ...
  "1306": [
    ...
    { code: "130637", name: "博野县" }, { code: "130638", name: "雄县" }, { code: "130681", name: "涿州市" },
